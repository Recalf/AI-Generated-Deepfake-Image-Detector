...
# Summary
This project detects whether an image is real or AI-generated / Deepfake using **ConvNeXtV2-Base (256×256)**, pretrained on ImageNet-1K.<br>
Trained in two phases: first on ~400k images, then with a **Continual Learning** cycle to adapt to the latest generative AI models.

The model detects images generated by many state-of-the-art (SOTA) generative models, including **DALL-E3, Flux, Nano Banana Pro, Diffusion Models (SDXL, SD3...), MidjourneyV6**... as fake.
